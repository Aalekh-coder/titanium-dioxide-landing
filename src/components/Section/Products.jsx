      ...
      <div className="px-3 grid grid-cols-2 items-center gap-2">
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogContent className="bg-[#EEE6CA] rounded-3xl px-5 ">
            <h3 className="font-bold text-xl text-center">Get Your Free sample Now</h3>
            <p className="text-sm text-center">Know the excellence of our &apos;A-Grade&apos; products by trying a free sample</p>
            ...
            <form onSubmit={handleSubmit} className="text-black my-2">
              ...
              <div className="flex flex-col mb-1">
                ...
                <select
                  type=""
                  id="productSelect"
                  className=" border px-1 py-2 bg-white text-black text-black"
                >
              ...
              <button type="submit" className="bg-black text-white mt-5 px-5 w-full py-2 font-medium rounded">
                Submit
              </button>
